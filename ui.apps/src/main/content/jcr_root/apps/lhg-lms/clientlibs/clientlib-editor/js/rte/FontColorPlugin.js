(function (CUI) {
  //'use strict';
  CTL.rte.plugins.FontColorsPlugin = new Class({

    toString: 'FontColorsPlugin',
    ...
    initializeUI: function (tbGenerator, options) {
      ...
      if (this.isFeatureEnabled('fontcolors')) { 
        this.stylesUI = new tbGenerator.createCTLStyleSelector('fontcolors', this, null,
          this.getStyles());
        tbGenerator.addElement('fontcolors', plg.Plugin.SORT_STYLES, this.stylesUI, 10);
      }
    },
...
// register plugin
  CUI.rte.plugins.PluginRegistry.register('fontcolors', CTL.rte.plugins.FontColorsPlugin);
}(window.CUI));
