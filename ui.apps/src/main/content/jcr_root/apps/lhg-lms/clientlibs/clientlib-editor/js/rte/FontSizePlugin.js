(function (CUI) {
  //'use strict';
  CTL.rte.plugins.FontSizePlugin = new Class({

    toString: 'FontSizePlugin',
    ...
    initializeUI: function (tbGenerator, options) {
      ...
      if (this.isFeatureEnabled('fontsize')) { 
        this.stylesUI = new tbGenerator.createCTLStyleSelector('fontsize', this, null,
          this.getStyles());
...
// register plugin
  CUI.rte.plugins.PluginRegistry.register('fontsize', CTL.rte.plugins.FontSizePlugin);
}(window.CUI));
